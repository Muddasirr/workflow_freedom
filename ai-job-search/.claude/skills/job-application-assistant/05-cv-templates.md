...
**For fullstack / product engineer roles:**
> Software engineer shipping end-to-end web products with Next.js, TypeScript, and Node. Recent work includes a no-code platform (dynamic database module, drag-and-drop workflows) and fintech REST APIs in Java. Comfortable owning schema-to-UI delivery and integrating AI features where they create user value.

**For frontend engineer roles:**
> Frontend-focused software engineer specializing in React and Next.js product UI. Experience building drag-and-drop workflow builders, ReactFlow graphs, Monaco-based editors, and design-system components with Material UI, Tailwind, and shadcn/ui. Strong emphasis on interactive UX that reduces setup time for end users.

**For AI / LLM application engineer roles:**
> Software engineer building applied AI systems with LangChain/LangGraph on top of strong fullstack delivery. Designed and shipped AutoCloudEngineerAgent, a LangGraph control plane that proposes infra configs, deploys only to a Kubernetes canary cell, runs invariant benches, and promotes or rolls back under hard safety constraints. Combines agent orchestration with production web engineering in Next.js and Python.
